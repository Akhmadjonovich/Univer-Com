...
import { Lock, User, ArrowRight, ShieldCheck, Loader2 } from "lucide-react"; // Ikonkalar uchun
...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#f8fafc] relative overflow-hidden">
      ...
      {/* Orqa fon uchun dekorativ aylana (blob) */}
      ...
      <div className="w-full max-w-md px-6 relative z-10">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-slate-500 mt-2 font-medium">
            Tashkilot profilingizga kiring
          </p>
        </div>

        {/* Login Card */}
        <div className="bg-white/70 backdrop-blur-xl p-8 md:p-10 rounded-[32px] shadow-[0_20px_50px_rgba(0,0,0,0.04)] border border-white">
          <div className="space-y-5">
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-4 bg-white border border-slate-200 rounded-2xl outline-none focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 transition-all font-medium text-slate-700 placeholder:text-slate-300"
                  value={loginInput}
            ...
            {/* Forget Password (Shunchaki vizual) */}
            ...
            <button
              ...
              className="w-full bg-slate-900 hover:bg-slate-800 text-white py-4 rounded-2xl font-bold flex items-center justify-center gap-2 transition-all active:scale-[0.98] disabled:opacity-70 disabled:cursor-not-allowed shadow-lg shadow-slate-200"
            >
              {isSubmitting ? (
        ...
        <p className="text-center mt-8 text-slate-500 font-medium text-sm">
          Tashkilotingiz hali ro'yxatdan o'tmaganmi? <br />
          <button className="text-indigo-600 font-bold hover:underline">Biz bilan bog'laning</button>
        </p>
      </div>
    </div>
  );
